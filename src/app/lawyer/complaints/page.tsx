...
const mockComplaints: Complaint[] = [
  {
    ...
    assignedLawyer: "Advocate Sharma",
  ...
  },
  {
    ...
    assignedLawyer: "Advocate Verma",
    caseNumber: "C-2024-002"
  }
]

export default function LawyerComplaintsPage() {
          ...
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-sm text-gray-600">Manage and review legal complaints</p>
              </div>
            </div>
                  ...
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex-1">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 text-sm text-gray-600">
                        ...
                        <div>
                          <span className="font-medium">Client:</span> {complaint.citizenName}
                        </div>
                        <div>
                        ...
                        {complaint.assignedLawyer && (
                          <div className="md:col-span-2">
                            <span className="font-medium">Assigned Lawyer:</span> {complaint.assignedLawyer}
                          </div>
                        )}
                        {complaint.location && (
                          <div className="md:col-span-2">
