...
interface Complaint {
  ...
  title: string
  description: string
  status: 'SUBMITTED' | 'UNDER_REVIEW' | 'APPROVED' | 'REJECTED' | 'ASSIGNED' | 'IN_PROGRESS'
  category: string
...
const mockComplaints: Complaint[] = [
  ...
  },
  {
    ...
    title: "Theft Report",
    description: "Theft of personal belongings from office",
    status: "UNDER_REVIEW",
    category: "CRIMINAL",
    priority: "HIGH",
...
export default function PoliceComplaintsPage() {
  ...
  const handleCreateFIR = (complaintId: string) => {
    router.push(`/police/firs/new?complaint=${complaintId}`)
  }
          ...
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-sm text-gray-600">Review and manage assigned complaints</p>
              </div>
            </div>
              ...
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-bold text-gray-900">
                    {complaints.filter(c => c.status === "SUBMITTED" || c.status === "UNDER_REVIEW").length}
                  </p>
                </div>
              </div>
            </CardContent>
                    ...
                    <div className="flex space-x-2">
                      ...
                      {(complaint.status === "SUBMITTED" || complaint.status === "UNDER_REVIEW") && (
                        <Button 
                          variant="outline" 
                          size="sm"
                          onClick={() => handleCreateFIR(complaint.complaintId)}
                        >
