  ...
  try {
    ...
    server.listen(currentPort, hostname, () => {
      ...
      if (err.code === 'EADDRINUSE') {
        ...
        server.listen(currentPort + 1, hostname, () => {
          console.log(`> Ready on http://${hostname}:${currentPort + 1}`);
          console.log(`> Socket.IO server running at ws://${hostname}:${currentPort + 1}/api/socketio`);
        });
      } else {
